...
hold on;
plot(1:pathInfo.numIter, pathInfo.pathGainHistory, "--", "LineWidth", 1.2);
plot(1:snrInfo.numIter, snrInfo.pathGainHistory, ":", "LineWidth", 1.2);
...
hold on;
plot(1:pathInfo.numIter, pathInfo.snrDbHistory, "--", "LineWidth", 1.2);
plot(1:snrInfo.numIter, snrInfo.snrDbHistory, ":", "LineWidth", 1.2);
...
hold on;
semilogy(1:pathInfo.numIter, pathInfo.condHistory, "--", "LineWidth", 1.2);
semilogy(1:snrInfo.numIter, snrInfo.condHistory, ":", "LineWidth", 1.2);
